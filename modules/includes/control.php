<ul class="nav nav-tabs inline nav-controls">
    ...
    <li class="pull-right right transparent" id="filter-type">
        <ul class="nav nav-tabs inline tab-right" data-filter-group>
            <li class="middle-block transparent button-list" data-filter="all" data-type="list-filter" >
                <img src="images/list.png" alt="">
            </li>
            <li class="middle-block transparent button-gird" data-filter="all" data-type="grid-filter" >
